...
//    	g2o::BlockSolverX::LinearSolverType * linearSolver = new LinearSolverCSparse<g2o::BlockSolverX::PoseMatrixType>();

	std::unique_ptr<BlockSolverX::LinearSolverType> linearSolver ( new g2o::LinearSolverCSparse<BlockSolverX::PoseMatrixType>());
